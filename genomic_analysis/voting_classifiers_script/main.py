...
from train_voting import training_models
from plot_curves import save_predictions
import os

from train_voting_Keras import training_keras_model
    ...
    if AE:
        ...
        for dim_folder in tqdm(os.listdir(training_path)):
            ...
            for filename in tqdm(os.listdir(folder)):
                ...
                if gene != 'TTN':
                    save_path = os.path.join(logs_path, dim_folder, gene)
                    os.makedirs(save_path, exist_ok=True)
                    ...
                    classifiers = training_keras_model(X, y, save_path=save_path, gene=gene)
        ...
        for filename in  tqdm(os.listdir(training_path)):
            ...
            y = train_df['label'] #target variable
            #classifiers = training_models(X_scaled, y, save_path=save_path)
            classifiers = training_keras_model(X, y, save_path=save_path, gene=gene)
