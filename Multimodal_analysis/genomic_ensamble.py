...
def ensamble_gen(path, fold):
        ...
        for csv_file in os.listdir(path):
            ...
            if csv_file.endswith('.csv'):
                ...
                dest_path = os.path.join(r'E:\Users\Berloco\PycharmProjects\CLAM\genomic_analysis\InferenceCPTACRna\ensemble_predictionsDEG', gene)
                os.makedirs(dest_path, exist_ok=True)
                mean_predictions.to_csv(os.path.join(dest_path, csv_file), index=False)
...
if __name__ == '__main__':
    ...
    gen_path = r'E:\Users\Berloco\PycharmProjects\CLAM\Multimodal_analysis\probs_data\DEG'
